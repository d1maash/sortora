...
import { VERSION, loadConfig, saveConfig, getAppPaths, ensureDirectories, expandPath, getAIProviderConfig, type AIProviderType } from './config.js';
...
// ═══════════════════════════════════════════════════════════════
// RENAME command - Smart file renaming with AI
// ═══════════════════════════════════════════════════════════════
program
  .command('rename <path>')
    ...
    try {
      ...
      for (let i = 0; i < suggestions.length; i++) {
        ...
        if (options.auto) {
          ...
          shouldRename = action === 'accept' || action === 'edit';
...
// ═══════════════════════════════════════════════════════════════
// AI command - manage AI providers
// ═══════════════════════════════════════════════════════════════
program
  .command('ai')
